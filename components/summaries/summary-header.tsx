    ...
    <div className="mb-4 flex justify-between gap-4">
      <div className="space-y-6">
        <div className="flex flex-wrap items-center gap-4">
          ...
          >
            <SparklesIcon className="mr-1.5 size-4 text-rose-500" />
            AI Summary
          </Badge>
      ...
      <div className="self-start">
        ...
        >
          <Link href="/dashboard">
            <ChevronLeftIcon className="size-4 text-rose-500 transition-transform group-hover:translate-x-0.5 sm:size-5" />
